...
public class S1M0_forest extends BaseAppState{
    ...
    private Vector3f playerSpawnPoint = new Vector3f(908f, 40f, -1195f);
    ...
    private final int FLOWER_COUNT = 5000;
    ...
    private final int LAND_SIZE = 5000; //maximum size of the square area for planting vegetation and place objects
...
//        PlayGame.gameplayAppState.firstPersonPlayer.setPhysicsLocation(setRandomPlayerSpawnPoint());
    ...
    public void update(float tpf) {
        ...
        PlayGame.screenLoading.update(tpf+10);
    }
...
//          //modelManager.createRandomizedModel("Models/Vegetation/Trees/Poplar/Poplar_blend.obj", ModelManager.staticNode, 1, -1000, 1000, -1000, 1000, 5, 0f, 4f, 6f, true);
     ...
     public void particleButterfly(){
            ...
            butterflyEmitter.getParticleInfluencer().setVelocityVariation(1.0f); //1.0f = random 360° directions //0.5f = 180 degrees
...
//            rootNode.addLight(ambient);
        ...
        public void createSceneAtDay(){
            ...
            sunPosition.setDirection(new Vector3f(0f, -3f, 5.9f).normalizeLocal()); //higher negative y value makes the shadow distance shorter
            ...
            effectManager.createGodRaysEffect(3000f, 6000f, -5200f, 1f);
