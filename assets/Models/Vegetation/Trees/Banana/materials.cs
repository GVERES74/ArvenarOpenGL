...
{
   mapTo = "Ban_Leaf_01";
   diffuseMap[0] = "BananaLeaf01.dds";
   specular[0] = "0.9 0.9 0.9 1";
   specularPower[0] = "25";
   translucentBlendOp = "None";
   normalMap[0] = "BananaLeaf01_NRM.dds";
   specularMap[0] = "BananaLeaf01_SPEC.dds";
   useAnisotropic[0] = "1";
   subSurface[0] = "1";
   subSurfaceColor[0] = "0.701961 0.764706 0.423529 1";
   doubleSided = "1";
   alphaTest = "1";
   alphaRef = "40";
};
...
{
   mapTo = "Ban_Leaf_02";
   diffuseMap[0] = "BananaLeaf02.dds";
   specular[0] = "0.9 0.9 0.9 1";
   specularPower[0] = "20";
   translucentBlendOp = "None";
   useAnisotropic[0] = "1";
   subSurface[0] = "1";
   subSurfaceColor[0] = "0.792157 1 0 1";
   doubleSided = "1";
   alphaTest = "1";
   alphaRef = "40";
   normalMap[0] = "BananaLeaf01_NRM.dds";
   specularMap[0] = "Banana/BananaLeaf01_SPEC.dds";
};
...
singleton Material(Banana01_bananabark01)
{
   ...
   specularPower[0] = "10";
   translucentBlendOp = "None";
   normalMap[0] = "banana_bark_NRM.dds";
   useAnisotropic[0] = "1";
};

singleton Material(Banana01_ColorEffectR225G198B87_material)
{
...
singleton Material(Banana01_Ban_Leaf_04)
{
   mapTo = "Ban_Leaf_04";
   ...
   useAnisotropic[0] = "1";
   subSurface[0] = "1";
   subSurfaceColor[0] = "0.592157 0.670588 0.294118 1";
   doubleSided = "1";
   alphaTest = "1";
   alphaRef = "40";
};

singleton Material(Banana01_Material__35)
{
   mapTo = "Material__35";
   diffuseMap[0] = "art/shapes/trees/Banana/banana_bark";
   specular[0] = "0.9 0.9 0.9 1";
   specularPower[0] = "10";
   translucentBlendOp = "None";
   normalMap[0] = "art/shapes/trees/Banana/banana_bark_NRM.png";
};
...
singleton Material(Banana02_NannerBark02)
{
   ...
   specularPower[0] = "10";
   translucentBlendOp = "None";
   normalMap[0] = "art/shapes/trees/Banana/banana_bark_NRM.dds";
};
...
singleton Material(Banana02_Nanner02)
{
   ...
   useAnisotropic[0] = "1";
   subSurface[0] = "1";
   subSurfaceColor[0] = "0.72549 0.835294 0.294118 1";
   doubleSided = "1";
   alphaTest = "1";
   alphaRef = "60";
   specularMap[0] = "BananaLeaf01_SPEC.dds";
...
singleton Material(Banana02_Nanner01)
{
   ...
   useAnisotropic[0] = "1";
   subSurface[0] = "1";
   subSurfaceColor[0] = "0.596078 0.670588 0.27451 1";
   doubleSided = "1";
   alphaTest = "1";
   alphaRef = "60";
   normalMap[0] = "BananaLeaf01_NRM.dds";
